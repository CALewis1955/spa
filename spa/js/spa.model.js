...
spa.model = (function () { 
	...
	var
		...
		chat, personProto, makeCid, clearPeopleDb, completeLogin,
...
// a collection of person object.  Its public methods include:
...
//
	...
	if (cid === undefined || ! name ) {
			...
			console.log("I'm in the throw function");
		}
	...
	// The chat object provides methos and events to manage
	...
	// 			peoplke list and avatar information (the css_map in the 
	...
	// 		* spa-updatechat - This is published when a new message is 
	// 			received or sent.  A map of the form:
	// 				{ dest_id		: <chatee_id>,
